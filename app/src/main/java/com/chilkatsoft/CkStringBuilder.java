...
public class CkStringBuilder {
  ...
  public boolean AppendBd(SWIGTYPE_p_CkBinData binData, String charset, int offset, int numBytes) {
    return chilkatJNI.CkStringBuilder_AppendBd(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(binData), charset, offset, numBytes);
  }
