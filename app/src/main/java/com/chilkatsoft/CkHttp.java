...
public class CkHttp {
  ...
  public boolean DownloadBd(String url, SWIGTYPE_p_CkBinData binData) {
    return chilkatJNI.CkHttp_DownloadBd(swigCPtr, this, url, SWIGTYPE_p_CkBinData.getCPtr(binData));
  }

  public CkTask DownloadBdAsync(String url, SWIGTYPE_p_CkBinData binData) {
    long cPtr = chilkatJNI.CkHttp_DownloadBdAsync(swigCPtr, this, url, SWIGTYPE_p_CkBinData.getCPtr(binData));
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean QuickGetBd(String url, SWIGTYPE_p_CkBinData binData) {
    return chilkatJNI.CkHttp_QuickGetBd(swigCPtr, this, url, SWIGTYPE_p_CkBinData.getCPtr(binData));
  }

  public CkTask QuickGetBdAsync(String url, SWIGTYPE_p_CkBinData binData) {
    long cPtr = chilkatJNI.CkHttp_QuickGetBdAsync(swigCPtr, this, url, SWIGTYPE_p_CkBinData.getCPtr(binData));
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
