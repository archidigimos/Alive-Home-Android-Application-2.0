...
public class CkSocket {
  ...
  public boolean ReceiveBd(SWIGTYPE_p_CkBinData binData) {
    return chilkatJNI.CkSocket_ReceiveBd(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(binData));
  }

  public CkTask ReceiveBdAsync(SWIGTYPE_p_CkBinData binData) {
    long cPtr = chilkatJNI.CkSocket_ReceiveBdAsync(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(binData));
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean ReceiveBdN(long numBytes, SWIGTYPE_p_CkBinData binData) {
    return chilkatJNI.CkSocket_ReceiveBdN(swigCPtr, this, numBytes, SWIGTYPE_p_CkBinData.getCPtr(binData));
  }

  public CkTask ReceiveBdNAsync(long numBytes, SWIGTYPE_p_CkBinData binData) {
    long cPtr = chilkatJNI.CkSocket_ReceiveBdNAsync(swigCPtr, this, numBytes, SWIGTYPE_p_CkBinData.getCPtr(binData));
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean SendBd(SWIGTYPE_p_CkBinData binData, long offset, long numBytes) {
    return chilkatJNI.CkSocket_SendBd(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(binData), offset, numBytes);
  }

  public CkTask SendBdAsync(SWIGTYPE_p_CkBinData binData, long offset, long numBytes) {
    long cPtr = chilkatJNI.CkSocket_SendBdAsync(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(binData), offset, numBytes);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
