...
public class CkRest {
  ...
  public boolean FullRequestBd(String httpVerb, String uriPath, SWIGTYPE_p_CkBinData binData, CkStringBuilder responseBody) {
    return chilkatJNI.CkRest_FullRequestBd(swigCPtr, this, httpVerb, uriPath, SWIGTYPE_p_CkBinData.getCPtr(binData), CkStringBuilder.getCPtr(responseBody), responseBody);
  }

  public CkTask FullRequestBdAsync(String httpVerb, String uriPath, SWIGTYPE_p_CkBinData binData, CkStringBuilder responseBody) {
    long cPtr = chilkatJNI.CkRest_FullRequestBdAsync(swigCPtr, this, httpVerb, uriPath, SWIGTYPE_p_CkBinData.getCPtr(binData), CkStringBuilder.getCPtr(responseBody), responseBody);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean FullRequestNoBodyBd(String httpVerb, String uriPath, SWIGTYPE_p_CkBinData binData) {
    return chilkatJNI.CkRest_FullRequestNoBodyBd(swigCPtr, this, httpVerb, uriPath, SWIGTYPE_p_CkBinData.getCPtr(binData));
  }

  public CkTask FullRequestNoBodyBdAsync(String httpVerb, String uriPath, SWIGTYPE_p_CkBinData binData) {
    long cPtr = chilkatJNI.CkRest_FullRequestNoBodyBdAsync(swigCPtr, this, httpVerb, uriPath, SWIGTYPE_p_CkBinData.getCPtr(binData));
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
